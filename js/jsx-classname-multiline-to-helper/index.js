...
const _createObjectExpression = j => (entries) => {
  return j.objectExpression(entries.map(([property, value]) => {
...
module.exports = (fileInfo, api, options) => {
  ...
  classAttrName.forEach((classAttrName) => {
    ...
    classNameAttrs.forEach((path) => {
      ...
      .forEach((quasi, index) => {
        ...
        const filtered = classNames.map(createLiteral)
        cxArguments.push(...filtered);
  ...
  // Insert the classnames CommonJS import statement
